...
class AnthropicAdapter(LLMAdapter):
    ...
    @staticmethod
    def _split_system(messages: list[dict], extra_system: str | None) -> tuple[str | None, list[dict]]:
    ...
    def complete(self, messages: list[dict], **kwargs) -> str:
        ...
        params = dict(model=self._model, max_tokens=self._max_tokens, messages=api_msgs, **kwargs)
        if system:
